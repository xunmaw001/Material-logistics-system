        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='yonghu'">
                    <el-form-item class="select" v-if="type!='info'"  label="司机" prop="yonghuId">
                        <el-select v-model="ruleForm.yonghuId" :disabled="ro.yonghuId" filterable placeholder="请选择司机" @change="yonghuChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='yonghu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="司机姓名" prop="yonghuName">
                        <el-input v-model="yonghuForm.yonghuName"
                                  placeholder="司机姓名" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="司机姓名" prop="yonghuName">
                ...
                <el-col :span="12"  v-if="sessionTable !='yonghu' ">
                    <el-form-item class="input" v-if="type!='info'"  label="司机身份证号" prop="yonghuIdNumber">
                        <el-input v-model="yonghuForm.yonghuIdNumber"
                                  placeholder="司机身份证号" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="司机身份证号" prop="yonghuIdNumber">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="车牌号" prop="cheliangName">
                       <el-input v-model="ruleForm.cheliangName"
                                 placeholder="车牌号" clearable  :readonly="ro.cheliangName"></el-input>
                   </el-form-item>
                   <div v-else>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="车辆排量" prop="cheliangPailiang">
                       <el-input v-model="ruleForm.cheliangPailiang"
                                 placeholder="车辆排量" clearable  :readonly="ro.cheliangPailiang"></el-input>
                   </el-form-item>
                   <div v-else>
