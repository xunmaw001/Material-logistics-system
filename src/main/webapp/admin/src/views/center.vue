<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='yonghu'"  label='司机姓名' prop="yonghuName">
               <el-input v-model="ruleForm.yonghuName"  placeholder='司机姓名' clearable></el-input>
           </el-form-item>
         </el-col>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='yonghu'"  label='司机身份证号' prop="yonghuIdNumber">
               <el-input v-model="ruleForm.yonghuIdNumber"  placeholder='司机身份证号' clearable></el-input>
           </el-form-item>
         </el-col>
